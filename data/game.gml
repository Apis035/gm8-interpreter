...
sMyPlane      = sprite_add(spr + "myplane.bmp", 3, true, false, 32, 32)
sLife         = sprite_add(spr + "life.bmp", 1, true, false, 0, 0)
sBottom       = sprite_add(spr + "bottom.bmp", 1, false, false, 0, 0)
sIsland1      = sprite_add(spr + "island1.bmp", 1, true, false, 0, 0)
sIsland2      = sprite_add(spr + "island2.bmp", 1, true, false, 0, 0)
sIsland3      = sprite_add(spr + "island3.bmp", 1, true, false, 0, 0)
sEnemy1       = sprite_add(spr + "enemy1.bmp", 3, true, false, 16, 16)
sEnemy2       = sprite_add(spr + "enemy2.bmp", 3, true, false, 16, 16)
sEnemy3       = sprite_add(spr + "enemy3.bmp", 3, true, false, 16, 16)
sEnemy4       = sprite_add(spr + "enemy4.bmp", 3, true, false, 16, 16)
sBullet       = sprite_add(spr + "bullet.bmp", 1, true, false, 16, 16)
sEnemyBullet1 = sprite_add(spr + "enemybullet1.bmp", 1, true, false, 16, 16)
sEnemyBullet2 = sprite_add(spr + "enemybullet2.bmp", 1, true, false, 16, 16)
sExplosion1   = sprite_add(spr + "explosion1.bmp", 6, true, false, 16, 16)
sExplosion2   = sprite_add(spr + "explosion2.bmp", 7, true, false, 32, 32)

//LOAD SOUNDS
globalvar aExplosion1, aExplosion2, aExplosion3, aMusic;
...
aExplosion3   = sound_add(snd + "explosion3.wav", 0, true)
aMusic        = sound_add(snd + "music.mid", 1, true)

//LOAD BACKGROUNDS
globalvar bWater, bScore;
var bg; bg    = working_directory + "\data\backgrounds\"
bWater        = background_add(bg + "water.bmp", false, false)
bScore        = background_add(bg + "score.bmp", false, false)
